...
public class DisplayMessage implements Message {
	...
	private GridCell minTemp, maxTemp; 
	private List<Double> meanTempOverRegion, meanTempOverTime;
	...
	public DisplayMessage(Map<Calendar, List<GridCell>> table, GridCell minTemp, GridCell maxTemp, List<Double> meanTempOverRegion, List<Double> meanTempOverTime, IGrid grid) {
